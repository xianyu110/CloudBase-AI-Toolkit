...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DestroyPlatformEnv)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DestroyPlatformEnv。 |
...
X-TC-Action: DestroyPlatformEnv
<公共请求参数>
...
{
    "Response": {
        "RequestId": "3482459c-d139-49ba-857a-c7f7a2b463ca"
    }
}
```
