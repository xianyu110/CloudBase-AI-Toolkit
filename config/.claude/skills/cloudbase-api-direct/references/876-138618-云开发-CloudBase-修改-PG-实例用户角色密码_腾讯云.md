...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=ResetPGAccountPassword)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：ResetPGAccountPassword。 |
...
示例值： ****\*\*\*\***** -migrate-d6a7e6f7aa8 |
| Password | 是 | String | 

要设置的密码

入参限制：长度8 ~ 32位，不能以" / "开头; 必须包含以下四项，字符种类: 小写字母： \[a ~ z\] 大写字母：\[A ～ Z\] 数字：0 - 9 特殊字符：()~!@#$%^& _\-+=\_|{}\[\]:<>,.?/\` 示例值：A8b!C2d#E4f&_
...
X-TC-Action: ResetPGAccountPassword
<公共请求参数>

{
    "EnvId": "************-migrate-d6a7e6f7aa8",
    "Password": "*********"
}
```
...
{
    "Response": {
        "RequestId": "08519f89-b618-42ff-861e-be4a9493c413"
    }
}
```
