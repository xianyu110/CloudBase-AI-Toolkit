...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribePlatformCreditsUsage)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribePlatformCreditsUsage。 |
...
示例值：pf-3iovc1ty3nug3 |

## 3\. 输出参数

| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| DeductValueCount | Float | 
资源点套餐内用量总和

  
示例值：8579960 |
| PackageDeductValueCount | Float | 

资源点资源包用量总和

  
示例值：0 |
| ReportValueCount | Float | 

资源点按量用量总和

  
示例值：123625.5 |
| DailyList | Array of [PlatformCreditsUsageDaily](/document/api/876/34822#PlatformCreditsUsageDaily) | 
...
### 示例1 DescribePlatformCreditsUsage
...
X-TC-Action: DescribePlatformCreditsUsage
<公共请求参数>
