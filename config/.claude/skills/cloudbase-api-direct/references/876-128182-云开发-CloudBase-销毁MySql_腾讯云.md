...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DestroyMySQL)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DestroyMySQL。 |
...
示例值： **s** r _pr **\*\*\***_ bc0df14561 |

## 3\. 输出参数

| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Data | [DestroyMySQLResult](/document/api/876/34822#DestroyMySQLResult) | 销毁结果 |
