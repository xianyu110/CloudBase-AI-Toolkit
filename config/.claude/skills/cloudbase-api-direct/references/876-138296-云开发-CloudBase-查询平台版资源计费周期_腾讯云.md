...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribePlatformAccountCircle)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribePlatformAccountCircle。 |
...
示例值：2026-08-20 21:01:24 |
| EndTime | String | 

套餐计费周期结束时间

  
示例值：2026-09-20 23:59:59 |
...
X-TC-Action: DescribePlatformAccountCircle
<公共请求参数>
