...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DeleteProvider)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DeleteProvider。 |
...
| EnvId | 是 | String | 环境ID  
示例值：github |
| Id | 是 | String | 认证源ID，比如：github, 格式必须为：2-32位小写英文字符串或数字 |
