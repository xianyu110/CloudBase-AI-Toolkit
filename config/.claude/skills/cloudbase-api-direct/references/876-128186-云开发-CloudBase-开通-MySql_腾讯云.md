...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=CreateMySQL)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：CreateMySQL。 |
...
示例值： **s _e\*\*\*\*_** g1\*\*dbc0df14561 |
| DbInstanceType | 是 | String | Db类型: MYSQL  
示例值：MYSQL |
| MysqlVersion | 否 | String | mysql版本  
示例值：5.7 |
| VpcId | 否 | String | vpc Id  
示例值：vpc-py **\*\*** |
| SubnetId | 否 | String | 子网ID  
示例值：subnet-68r **\*** |
| LowerCaseTableNames | 否 | String | 0 区分表名大小写；1 不区分表名大小写(默认)  
示例值：1 |
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Data | [CreateMySQLResult](/document/api/876/34822#CreateMySQLResult) | 开通结果 |
