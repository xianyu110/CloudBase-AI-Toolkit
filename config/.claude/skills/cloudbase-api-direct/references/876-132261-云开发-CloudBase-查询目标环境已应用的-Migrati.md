...
## 查询目标环境已应用的 Migration

最近更新时间：2026-09-09 02:53:20
...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=ListPGUserMigrations)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：ListPGUserMigrations。 |
...
示例值：20260526000000 |
| Migrations | Array of [MigrationSummary](/document/api/876/34822#MigrationSummary) | 
...
X-TC-Action: ListPGUserMigrations
<公共请求参数>
