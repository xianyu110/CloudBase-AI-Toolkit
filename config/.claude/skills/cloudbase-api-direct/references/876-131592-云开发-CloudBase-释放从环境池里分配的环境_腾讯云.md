...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=ReleaseEnv)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：ReleaseEnv。 |
...
X-TC-Action: ReleaseEnv
<公共请求参数>

{
    "EnvId": "*******d2g0eh0ey8e8c1001",
    "AllocateId": "all******"
}
```
...
{
    "Response": {
        "RequestId": "aee747a9-fe87-4da5-b589-8d9c29a31d33"
    }
}
```
...
| 错误码 | 描述 |
| --- | --- |
| InvalidParameter.MissingIdentifier | 资源标识参数未传 |
| ResourceNotFound.EnvNotExist | 环境不存在，未找到记录 |