...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=ModifyEnvExtra)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：ModifyEnvExtra。 |
...
X-TC-Action: ModifyEnvExtra
<公共请求参数>

{
    "EnvId": "pg-felixx-d7gokw0dv1c0b0fd6",
    "EnableOverrun": "true"
}
```
...
{
    "Response": {
        "RequestId": "319fce36-1aaf-45e6-9727-1cdde881986a"
    }
}
```
