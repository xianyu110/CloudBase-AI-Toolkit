...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=CreatePlatformEnv)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：CreatePlatformEnv。 |
...
```json
{
    "Response": {
        "EnvId": "platform01-******r**********",
        "RequestId": "68393676-975c-4eec-b485-36d4ee4f30a5"
    }
}
```
