...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribeTaskResult)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribeTaskResult。 |
...
示例值：Out of range value for column 'appid' at row 1 (type: MySQLError, retryable: true) |
| CreatedAt | String | 

创建时间

参数格式：2026-05-26T11:26:14+08:00

  
示例值：2026-05-26T11:26:13+08:00 |
| UpdatedAt | String | 
...
示例值：2026-05-26T11:26:14+08:00 |
| Params | Array of [ObjectKV](/document/api/876/34822#ObjectKV) | 
