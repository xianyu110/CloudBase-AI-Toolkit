...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribePlatforms)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribePlatforms。 |
| Version | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：2018-06-08。 |
| Region | 否 | String | [公共参数](/document/api/876/34812) ，本接口不需要传递此参数。 |
| PlatformIds.N | 否 | Array of String | 
平台版套餐id列表

默认值：若不指定，则分页返回当前账号下所有平台版资源

  
示例值：\["pf-2v4plhx1ph2bq"\] |
| Limit | 否 | Integer | 
...
| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| PlatformList | Array of [PlatformInfo](/document/api/876/34822#PlatformInfo) | 
平台版资源列表
