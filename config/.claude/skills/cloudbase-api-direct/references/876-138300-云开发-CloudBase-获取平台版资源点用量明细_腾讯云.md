...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DescribePlatformCreditsUsageDetail)
...
| 参数名称 | 必选 | 类型 | 描述 |
| --- | --- | --- | --- |
| Action | 是 | String | [公共参数](/document/api/876/34812) ，本接口取值：DescribePlatformCreditsUsageDetail。 |
...
示例值：pf-35zc08k5rfxtq |

## 3\. 输出参数

| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Usages | Array of [PlatformPkgCreditsUsage](/document/api/876/34822#PlatformPkgCreditsUsage) | 
用量数据
...
### 示例1 DescribePlatformCreditsUsageDetail
...
X-TC-Action: DescribePlatformCreditsUsageDetail
<公共请求参数>
