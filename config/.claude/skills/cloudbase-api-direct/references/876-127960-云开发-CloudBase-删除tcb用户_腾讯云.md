...
[点击调试](https://console.cloud.tencent.com/api/explorer?Product=tcb&Version=2018-06-08&Action=DeleteUsers)
...
示例值：\["19837204372934434"\] |

## 3\. 输出参数

| 参数名称 | 类型 | 描述 |
| --- | --- | --- |
| Data | [DeleteUsersResp](/document/api/876/34822#DeleteUsersResp) | 删除用户结果 |
